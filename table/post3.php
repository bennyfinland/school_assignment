...
$sql = "SELECT memberID,name,email FROM filmmembers $where $sort $limit";
$result = runSQL($sql);

$total = countRec('memberID','filmmembers',$where);
...
if ($rc) $json .= ",";
$json .= "\n{";
$json .= "memberID:'".$row['memberID']."',";
$json .= "cell:['".$row['memberID']."','".$row['name']."'";
